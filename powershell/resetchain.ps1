...
while ((Invoke-WebRequest -Uri http://159.203.48.172/rebuilding.txt -UseBasicParsing).Content -eq "true")
{
  echo "The bootstrap file is being updated on the server. Checking again in 15 seconds."
  sleep 15
}
